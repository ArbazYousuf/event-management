                ...
                <ScrollView style={{ flex: 1, width: "100%" }} contentContainerStyle={{ justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View style={{ justifyContent: 'flex-start', alignItems: 'flex-start', margin: 10, width: "90%" }}>
                        <View style={{ flex: 1, flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                            ...
                            <Icon style={{ padding: 7.7, color: "white", backgroundColor: "rgba(255, 255,255, 0.2)" }} type="AntDesign" name="clockcircle" />
                        </View>
                    </View>
                    <View style={{ justifyContent: 'flex-start', alignItems: 'flex-start', margin: 10, width: "90%" }}>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', margin: 10, width: "100%" }}>
                        <Button
                            onPress={() => Actions.todoList()}
                            style={{ flex: 1, width: 200, backgroundColor: "rgba(255, 255,255, 0.7)", borderWidth: 1, borderRadius: 5, borderColor: "transparent" }}>
                            <Text style={{ textAlign: "center", width: "100%" }}>Save event</Text>
                        </Button>
                    </View>
                </ScrollView>
                {/* </ScrollView> */}
